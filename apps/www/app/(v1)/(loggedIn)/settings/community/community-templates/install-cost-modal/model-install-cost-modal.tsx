          ...
          <div className="flex-1 flex flex-col  pl-2 gap-2">
            <Tabs defaultValue="contractor" className="">
              <TabsList>
                ...
                <TabsTrigger value="punchout">Punchout</TabsTrigger>
              </TabsList>
              {["contractor", "punchout"].map((type) => (
                <TabsContent key={type} className="flex flex-col" value={type}>
                    ...
                    <Table className="">
                      <TableHeader>
                        <TableRow>
                          ...
                          {community && (
                            <TableHead className="px-1">Def. Qty</TableHead>
                          )}
  ...
  return (
    <Badge
      ...
      className={cn(
        ...
        !form.getValues(`costs.0.costings.${costLine.uid}`) && Number(qty) > 0
