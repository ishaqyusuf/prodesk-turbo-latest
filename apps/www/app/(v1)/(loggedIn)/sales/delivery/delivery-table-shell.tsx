...
export default function DeliveryTableShell({
  ...
  const columns = useMemo<ColumnDef<ISalesOrder, unknown>[]>(
    () => [
      ...
      {
        accessorKey: "orderId",
        cell: ({ row }) => OrderIdCell(row.original, "/sales/production/slug"),
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <>
            <TableCol.Primary>{row.original.salesRep?.name}</TableCol.Primary>
          </>
        ),
      },
      {
      ...
      ..._FilterColumn("_status", "_customerId", "_deliveryStatus"),
      {
        ...
        cell: ({ row }) => (
          <>
            <RowActionCell>
              <RowActionMoreMenu>
                <RowActionMenuItem>Ready For Delivery</RowActionMenuItem>
              </RowActionMoreMenu>
            </RowActionCell>
          </>
        ),
