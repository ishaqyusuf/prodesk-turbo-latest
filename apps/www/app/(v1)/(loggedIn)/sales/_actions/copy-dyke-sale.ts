        ...
        const shelfItemArray = itemA.item.shelfItemArray.map((sh) => {
          return {
            ...
            productArray: sh.productArray.map((p) => {
              return {
                ...p,
                item: removeKeys(p.item, ["id", "salesOrderItemId"]),
              };
            }),
          };
        });
          ...
          item: {
            ...
            housePackageTool: !itemA.item.housePackageTool
              ...
              : {
                  ...
                  doors: itemA.item.housePackageTool.doors?.map((door) =>
                    removeKeys(door, [
                      "id",
                      "housePackageToolId",
                      "salesOrderId",
                  ...
                  door: removeKeys(itemA.item.housePackageTool.door, [
                    "id",
                  ] as any),
                  _doorForm,
            ...
            formStepArray: itemA.item.formStepArray.map((f) => {
              return {
                ...f,
                item: removeKeys(f.item, ["id", "salesItemId", "salesId"]),
              };
            }),
            shelfItemArray,
          },
