          ...
          <div className="sm:col-span-2 space-y-4">
            <div className="sm:w-1/2">
              ...
              <p className="text-muted-foreground">
                Email, call, or complete the form to learn how GND Millwork can
                provide a wonderful service for you.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 gap-4  sm:gap-8 lg:w-2/3">
              <div className="  ">
                <p className="uppercase font-bold mb-2">Office</p>

                <div className="py-0.5">13285 SW 131TH ST Miami, Fl 33186</div>
              </div>
              <div className="  ">
                <p className="uppercase font-bold mb-2">{list.opening.title}</p>
              ...
              <div className=" ">
                <p className="uppercase font-bold mb-2">{list.call.title}</p>
              ...
              <div className=" ">
                <p className="uppercase font-bold mb-2">Email</p>
                {list.email.map((r) => (
                  <a
                    href={`mailto:${r}`}
                    key={r}
