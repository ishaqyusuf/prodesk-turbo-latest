              ...
              <tr className="">
                ...
                <td valign="top" colSpan={5}>
                  <div className="text-xs font-semibold text-black/90">
                    ...
                    {ctx.sale.isProd && <p>Fax: 305-278-2003</p>}
                  ...
                  <table className="w-full table-fixed">
                    <tbody>
                      {sale?.heading?.lines?.map((h) => (
                        <tr key={h.title}>
                          <td colSpan={3} valign="bottom" className="font-bold">
                            {h.title}
                          </td>
                          <td colSpan={5} align="right">
                            <Text {...h.style}>{h.value}</Text>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                      ...
                      <td colSpan={6} className="">
                        {!sale.paymentDate || (
                          <div className="sabsolute watermark-text text-strokes   -rotate-45 -translate-y-6 translate-x-8 font-mono uppercase font-bold inline-flex flex-col ">
                            ...
                            <span className="text-2xl">{sale.paymentDate}</span>
                          </div>
                        )}
                      </td>
                    )}
                    <td colSpan={9} key={address?.title}>
                      <div className={cn("my-4  mb-4 flex flex-col")}>
                        <div>
