                ...
                <td colSpan={10}>
                  {report.amount < -1 ? (
                    ...
                    <>
                      <span>
                        INV #{report.inv}{" "}
                        {report.dueDate && `Due: ${report.dueDate}`}
                      </span>
                    </>
                  )}
                </td>
              ...
              <td className="p-0" colSpan={16}>
                <table id="footerTable" className="w-full">
                  ...
                  <tbody>
                    <tr>
                      <td align="center">
                        <Money noCurrency value={data.reportFooter.current} />
                      </td>
                      <td align="center">
                        <Money noCurrency value={data.reportFooter.past1} />
                      </td>
                      <td align="center">
                        <Money noCurrency value={data.reportFooter.past2} />
                      </td>
                      <td align="center">
                        <Money noCurrency value={data.reportFooter.past3} />
                      </td>
                      <td align="center">
                        <Money noCurrency value={data.reportFooter.over3} />
                      </td>
                      <td align="center">
                        <Money value={data.reportFooter.current} />
                      </td>
                    </tr>
                  </tbody>
                </table>
