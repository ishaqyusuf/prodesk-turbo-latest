  ...
  function SaveBtn() {
    return (
      ...
      >
        ...
        <MenuItem onClick={() => save("close")} Icon={Icons.saveAndClose}>
          Save & Close
        </MenuItem>
      ...
      >
        ...
        <div
          className={cn(
            ...
            scroll.isScrolled && "bg-accent py-2   shadow-sm border-b px-8",
          )}
        >
          <div className="">
          ...
          <div
            className={cn(
              dealerMode ? "hidden" : "flex items-center space-x-2",
            )}
          >
            <div className="inline-flex items-center space-x-2">
              ...
              <DatePicker
                ...
                setValue={(e) => form.setValue("order.createdAt", e)}
            ...
            {id && type == "order" && (
              <Btn
                ...
                onClick={() => {
                  modal.openSheet(
                    <PaymentModal id={id} orderId={orderId} form={form} />,
                  );
                }}
              >
                Payment
            ...
            <Btn
              ...
              variant={"outline"}
              onClick={() => {
                modal.openSheet(<SalesNoteModal id={id} orderId={orderId} />);
              }}
            >
              Notes
            </Btn>
            ...
            <Menu Icon={Icons.more}>
              ...
              <MenuItem
                onClick={() => {
                  modal.openSheet(<DykeSettingsModal form={form} />);
                }}
                Icon={Icons.settings}
              >
                Settings
