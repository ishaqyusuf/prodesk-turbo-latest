...
export default function HousePackageTool({ componentTitle }) {
  ...
  async function editSize() {
    ...
    const formStep = i.item.formStepArray.find((s) => s.step.title == "Door");
      ...
      <Table className="" id="housePackageTable">
        <TableHeader>
          ...
          {componentItem.calculatedPriceMode ? (
            <>
              <TableHead className="shidden lg:table-cell">Estimate</TableHead>
              <TableHead className={cn(ctx.dealerMode && "hidden")}>
                Addon/Qty
              </TableHead>
            </>
          ) : (
            <>
              <TableHead className="shidden lg:table-cell">Price</TableHead>
            </>
          )}
          <TableHead className="shidden lg:table-cell">Line Total</TableHead>
          <TableHead></TableHead>
        </TableHeader>
        <TableBody>
          {sizes
