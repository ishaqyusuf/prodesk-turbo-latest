      ...
      <LegacyDykeFormStepContext.Provider value={legacyStepCtx}>
        ...
        >
                    ...
                    <Card className="border-none flex flex-col h-full bg-red-50">
                      <StepProduct
                        className={cn(
                          ...
                          !sortMode && "hover:border-muted-foreground",
                        )}
                        ...
                        item={item as any}
                        itemIndex={i}
                        deleteStepItem={() => deleteStepItemModal([item])}
                  ...
                  <>
                    <div className="p-4">
                      <button
                        onClick={() => {
                          _modal.openModal(
                            <RestoreComponentsModal stepCtx={legacyStepCtx} />,
                          );
                        }}
                        className={cn(
          ...
          {isMultiSection && (
            <div className="flex justify-end">
              <Button onClick={() => selectProduct(false)}>Proceed</Button>
            </div>
          )}
        ...
        {sortMode && (
          <div className="fixed shadow-xl  z-10 mb-16 bottom-0 left-1/2">
            <Button
              onClick={() => stepHelpers.finishSort(legacyStepCtx)}
              size="sm"
            >
              Finish Sort
            </Button>
    ...
    <Form {...inputForm}>
      <div className="flex ">
        <div className="flex flex-col gap-2">
          <FormInput name="value" control={inputForm.control} label="Custom" />
          <FormInput
            name="price"
