    ...
    <Form {...categoryForm}>
      <TableRow>
        ...
        <TableCell className="w-full space-y-2 items-start  flex flex-col">
          {shelf.products && (
            <>
              {shelf.prodArray.fields.map((prodField, prodIndex) => (
                <ShellProductCells
                  onDelete={(index) => {
                    shelf.prodArray.remove(index);
                  }}
        ...
        <TableCell className="">
          <Button onClick={deleteItem} size="icon" variant={"destructive"}>
    ...
    <div className="w-full flex items-center space-x-4">
      <div className="flex-1">
        <ShelfSelect
          ...
          items={shelf.products?.map(({ title: label, id: value }) => ({
            label,
      ...
      <div className="w-20">
        <FormField
          control={shelf.categoryForm.control}
          name={`${shelf.shelfItemKey}.productArray.${index}.item.qty` as any}
          ...
          render={({ field }) => (
            <Input
              ...
              onChange={(e) => {
                ...
                shelf.updateProductPrice(index, null, +e.target.value);
              }}
            />
          )}
        />
