              ...
              value={
                sizeRow
                  ? sizeRow.overridePrice
                    ? sizeRow.overridePrice
                    : sum([sizeRow.jambSizePrice, sizeRow.componentsTotal])
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                {itemData.item.formStepArray
                  ...
                  .map((a) => (
                    <div key={a.step.id} className="border-b">
                      <div className="grid grid-cols-3  gap-2">
                        <Label htmlFor="maxWidth">{a.step.title}</Label>
                        <div className="text-left col-span-2">
                          <Money value={a.item.price} />
                          <TableCol.Secondary>
                            {a.item.value}
                          </TableCol.Secondary>
                        </div>
                ...
                {sizeRow && (
                  <div>
                    <div className="grid grid-cols-2 items-center gap-4">
                      <Label htmlFor="maxWidth">Door Price</Label>
                      <div className="text-left">
                        <Money value={sizeRow.jambSizePrice} />
                      </div>
                    </div>
                  </div>
                )}
                <div
                  className={cn("pt-2 border-t", ctx.dealerMode && "hidden")}
                >
                  <FormInput
