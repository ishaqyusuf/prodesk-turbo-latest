  ...
  return (
    <div className="xl:col-span-3 grid gap-2 xl:grid-cols-2 xl:gap-x-4">
      ...
      <InfoLine label="Q.B Order #">
        <FormInput size="sm" control={form.control} name="order.meta.qb" />
      </InfoLine>
      ...
      {type == "order" ? (
        <>
          ...
          <InfoLine label="P.O No.">
            <FormInput control={form.control} size="sm" name="order.meta.po" />
          </InfoLine>
        </>
      ) : (
        <InfoLine label="Good Until">
          <DateControl className="h-8 min-w-[150px]" name="order.goodUntil" />
        </InfoLine>
      )}
