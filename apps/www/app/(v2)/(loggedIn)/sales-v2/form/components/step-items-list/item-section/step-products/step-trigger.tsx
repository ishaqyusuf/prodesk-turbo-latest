    ...
    <Portal nodeId={stepActionNodeId}>
      <div className={cn("px-2", !superAdmin && "hidden")}>
        <Menu Icon={Icons.more}>
          <MenuItem onClick={() => conditionSettings("priceDepencies")}>
            Pricing Deps
          </MenuItem>
          ...
          <MenuItem
            onClick={() => {
              _modal.openModal(<RestoreComponentsModal stepCtx={stepCtx} />);
            }}
          >
            Restore Component
          </MenuItem>
          ...
          {stepCtx.isDoor && (
            <MenuItem
              onClick={() => {
                _modal.openSheet(<HeightSettingsModal ctx={stepCtx} />);
              }}
            >
              Height Settings
            </MenuItem>
