      ...
      <div className="sm:mx-4 sm:ml-10 shidden sm:block">
        <Table className="max-w-[80vw]">
          <TableHeader className="bg-slate-100">
            ...
            {!group.doorConfig.singleHandle && <TableHead>Handle</TableHead>}
            ...
            {salesDoor?.assignments?.map((assignment) => (
              <TableRow key={assignment.id} className="">
                ...
                {!group.doorConfig.singleHandle && (
                  <TableHead>{assignment.__report.handle}</TableHead>
                )}
                ...
                <TableCell>
                  {assignment.__report.submitted} of {assignment.__report.total}
                </TableCell>
                <TableCell>
                  <div>
                    {!assignment.submissions?.length ? (
                      ...
                      <TableCol.Status
                        score={assignment.__report.submitted}
