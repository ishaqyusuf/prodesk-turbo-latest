          ...
          <div className="text-sm p-2 border-b" key={si}>
            <div className="flex gap-4 justify-between items-center">
              ...
              <div className={cn(!group.isDyke)}>
                <SectionedItemAssignForm salesDoorIndex={si} index={index} />
              </div>
            </div>
            <div className="grid text-base gap-4 p-2 grid-cols-3 sm:grid-cols-5">
              ...
              {(group.doorConfig.doorType == "Garage" || !group.isDyke) && (
                <Info label="Swing" value={`${sd.salesDoor.swing}`} />
              )}
              {/* {!group.isDyke && (
              ...
              />
              <Info label="Completed" value={sd.report.completed} />
            </div>
...
function DetailsBlock({ children, group }) {
  ...
  return (
    ...
    >
      ...
      <div className={cn(showDetails ? "grid" : "hidden", " sm:grid-cols-2")}>
        {children}
      </div>
    </div>
  );
