          ...
          <TableBody key={com.id}>
            {com.meta.doorType == "Services" && (
              <TableRow>
                ...
                <TableCell>
                  <TableCol.Secondary>{com.qty}</TableCol.Secondary>
                </TableCell>
                <TableCell>
                  <TableCol.Secondary>
            ...
            {com.meta.doorType == "Moulding" && (
              <TableRow>
                <TableCell>{cid + 1}</TableCell>
                <TableCell>{com.housePackageTool?.molding?.title}</TableCell>
                <TableCell>
                  <TableCol.Secondary>{com.qty}</TableCol.Secondary>
                </TableCell>
                <TableCell>
            ...
            {com.housePackageTool?.doors.map((door) => (
              <TableRow id={`dyke-${cid}`} key={door.id}>
                ...
                {moulding.isType.hasSwing && (
                  <TableCell>
                    <TableCol.Secondary>{door.swing}</TableCol.Secondary>
                  </TableCell>
                )}
                {moulding.isType.multiHandles ? (
                  <>
                  ...
                  <TableCell>{door.lhQty || door.totalQty}</TableCell>
                )}
