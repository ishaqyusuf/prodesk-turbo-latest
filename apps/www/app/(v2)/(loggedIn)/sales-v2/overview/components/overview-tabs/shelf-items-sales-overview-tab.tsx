                ...
                <React.Fragment key={hpt.id}>
                  {hpt.doors.map((door, doorIndex) => (
                    <TableRow key={`door-${door.id}`}>
                      <TableCell>{doorIndex == 0 && hpt.door?.title}</TableCell>
                      <TableCell>{door.dimension}</TableCell>
                      <TableCell>
                        <Badge variant={"secondary"}>{door.lhQty}</Badge>
                      </TableCell>
                      <TableCell>
                        <Badge variant={"secondary"}>{door.rhQty}</Badge>
                      </TableCell>
                      <TableCell>
