      ...
      <SalesRowContext.Provider value={fieldArray}>
        <div className={cn("", isMobile && "max-md:w-[900px]")}>
          ...
          <Table
            ...
            className=""
          >
            <InvoiceTableHeader watchProfileEstimate={watchProfileEstimate} />
            <TableBody>
  ...
  return (
    ...
    >
      ...
      <TableCell className="p-0 px-1">
        <InputHelper index={index} formKey={"meta.isComponent"} checkbox />
      </TableCell>
...
function InputHelper({
  ...
  const keyDown = useCallback(
    (e) => {
      let k = e.key;
      if (props.type == "number" && !(+k > -1) && k?.length == 1 && k != ".") {
        e.preventDefault();
      }
