    ...
    <Context.Provider value={ctx}>
      <Modal.Content size="lg">
        <Modal.Header
          ...
          subtitle={"Add rules to make component show only when rules are met."}
        />
        <Form {...ctx.form}>
            ...
            <>
              <div className="">
                <span className="text-muted-foreground">
                  This component has not rules set, which means it will always
                  be visible in{" "}
          ...
          <div className="mt-2">
            <Button onClick={ctx.addRule} size="sm" className="h-8 text-xs">
        ...
        {ctx.componentsUid?.length > 1 ? (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Editing multiple components visibility will override any
              visibility settings on the selected components.
            </AlertDescription>
          </Alert>
        ) : null}
