          ...
          <TableBody>
            {shipping?.dispatches?.map((dispatch) => (
              <TableRow key={dispatch.id}>
                ...
                <TCell>
                  <TCell.Primary>{dispatch.uid}</TCell.Primary>
                </TCell>
                <TCell>
                  <TCell.Status status={dispatch.deliveryMode} />
                </TCell>
                <TCell>
                  <TCell.Status status={dispatch.assignedTo?.name} />
                </TCell>
                <TCell>
                  ...
                  <Menu>
                    ...
                    <Menu.Trash
                      action={async () => {
                        toast.promise(
                          async () => {
                            await deleteDispatchAction(dispatch.id);
                            return true;
                          },
                          {
                            loading: "Deleting....",
