...
export function SalesInfoTab({}) {
  ...
  return (
    <div>
      ...
      ></InfoLine>
      <SalesDateInline />
      <InfoLine label="Sales Rep" value={overview.salesRep?.name}></InfoLine>
          ...
          <div key={i}>
            ...
            {!k?.length ? (
              ...
              k.map((line, ki) => {
                ...
                return (
                  <div key={ki} className="flex gap-4 py-1 border-b">
                    {Ico && <Ico className="size-4 text-muted-foreground" />}
