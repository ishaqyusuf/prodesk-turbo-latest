...
export default function VerifyTaskJobsBeforeAssign() {
  ...
  return (
    <BaseModal<Props>
      ...
      Subtitle={({ data }) => (
        <>
          {data?.payload?.__taskSubtitle} has {data?.jobs?.length} jobs
          submitted.
        </>
      )}
      Footer={({ data }) => (
                ...
                <Table>
                  ...
                  <TableBody>
                    {data?.jobs?.map((job) => (
                      <TableRow key={job.id}>
                        <TableCell>
                          <DateCellContent>{job.createdAt}</DateCellContent>
                        </TableCell>
                        <TableCell>
                          <PrimaryCellContent>{job.title}</PrimaryCellContent>
                          <SecondaryCellContent>
                            {job.subtitle || job.description}
                          </SecondaryCellContent>
                        </TableCell>
                        <TableCell>
                          <PrimaryCellContent>
                      ...
                      <SelectContent>
                        <SelectGroup>
                          ...
                          <SelectItem value="ignoreAssignAndComplete">
                            Ignore Assignment, Mark Task as Completed
                          </SelectItem>
                        </SelectGroup>
                      </SelectContent>
                    </Select>
